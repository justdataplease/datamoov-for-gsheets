...
test('complete production bundle registers thirteen sources and sixteen reports without Google services', () => {
  ...
  assert.equal(catalog.reduce((count, connector) => count + connector.reports.length, 0), 16);
